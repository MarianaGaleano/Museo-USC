...
bool gamePaused;
    ...
    void Start()
    {
        ...
        if(crosshair)
        {
            ...
            crosshairObject.rectTransform.sizeDelta = new Vector2(190, 190);
        }
        else
        {
...
canvasObj.SetActive(true);
    ...
    Cursor.lockState = CursorLockMode.Locked;
        ...
        if(cameraCanMove)
        {
            ...
            transform.eulerAngles = new Vector3(Mathf.Clamp(pitch, -maxLookAngle, maxLookAngle), yaw, 0);
        }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.canvasObj = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Canvas", "Canvas."), fpc.canvasObj, typeof(GameObject), true);
